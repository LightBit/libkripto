...
int main(void)
{
	...
	kripto_hash_all(kripto_hash_blake2b, 0, 0, 0, "The quick brown fox jumps over the lazy dog", 43, hash, 64);
	...
	kripto_hash_all(kripto_hash_blake2b, 0, 0, 0, buf, 0, hash, 64);
	for(i = 0; i < 64; i++) printf("%.2x", hash[i]);
	putchar('\n');
