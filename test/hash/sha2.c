...
int main(void)
{
	...
	kripto_hash_all(kripto_hash_sha2_256, 0, 0, 0, "The quick brown fox jumps over the lazy dog", 43, hash, 28);
	for(i = 0; i < 28; i++) printf("%.2x", hash[i]);
	putchar('\n');

	/* 256 */
	puts("d7a8fbb307d7809469ca9abcb0082e4f8d5651e46d3cdb762d02d0bf37c9e592");
	kripto_hash_all(kripto_hash_sha2_256, 0, 0, 0, "The quick brown fox jumps over the lazy dog", 43, hash, 32);
	...
	kripto_hash_all(kripto_hash_sha2_512, 0, 0, 0, "The quick brown fox jumps over the lazy dog", 43, hash, 48);
	...
	kripto_hash_all(kripto_hash_sha2_512, 0, 0, 0, "The quick brown fox jumps over the lazy dog", 43, hash, 64);
