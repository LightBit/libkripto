...
)
{
	...
	return skein1024_recreate(s, r, key, key_len, iv, iv_len);
}
...
static const kripto_desc_stream skein1024 =
{
	&skein1024_create,
	&skein1024_recreate,
	&skein1024_crypt,
...
const kripto_desc_stream *const kripto_stream_skein1024 = &skein1024;
