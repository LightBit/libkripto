...
static const uint32_t pi[1060] =
{
	...
	0xDB75092E, 0xC4192623, 0xAD6EA6B0, 0x49A7DF7D,
	0x9CEE60B8, 0x8FEDB266, 0xECAA8C71, 0x699A17FF,
	...
	0xECC8C73E, 0xA4751E41, 0xE238CD99, 0x3BEA0E2F,
	0x3280BBA1, 0x183EB331, 0x4E548B38, 0x4F6DB908,
	0x6F420D03, 0xF60A04BF, 0x2CB81290, 0x24977C79,
	...
	0xBC9F9ABC, 0xE94B7D8C, 0xEC7AEC3A, 0xDB851DFA,
	...
	0xEBADFE6E, 0xEAC31F66, 0xE3BC4595, 0xA67BC883,
	0xB17F37D1, 0x018CFF28, 0xC332DDEF, 0xBE6C5AA5,
	0x65582185, 0x68AB9802, 0xEECEA50F, 0xDB2F953B,
	0x2AEF7DAD, 0x5B6E2F84, 0x1521B628, 0x29076170,
	0xECDD4775, 0x619F1510, 0x13CCA830, 0xEB61BD96,
	...
	0xE8EFD855, 0x61D99735, 0xA969A7AA, 0xC50C06C2,
	...
	0xBCF46B2E, 0xD4A20068, 0xD4082471, 0x3320F46A,
	...
	0x680EC0A4, 0x27A18DEE, 0x4F3FFEA2, 0xE887AD8C,
	0xB58CE006, 0x7AF4D6B6, 0xAACE1E7C, 0xD3375FEC,
	0xCE78A399, 0x406B2A42, 0x20FE9E35, 0xD9F385B9,
	...
	0xDFF8E8A3, 0x1F636C1B, 0x0E12B4C2, 0x02E1329E,
	...
	0xC39DFD27, 0xF33E8D1E, 0x0A476341, 0x992EFF74,
	...
	0xA002B5C4, 0x0DE6D027, 0x9AF88C27, 0x773F8641,
	...
	0xA28514D9, 0x6C51133C, 0x6FD5C7E7, 0x56E14EC4,
	0x362ABFCE, 0xDDC6C837, 0xD79A3234, 0x92638212,
	0x670EFA8E, 0x406000E0, 0x3A39CE37, 0xD3FAF5CF,
	0xABC27737, 0x5AC52D1B, 0x5CB0679E, 0x4FA33742,
	...
	0xC6A376D2, 0x6549C2C8, 0x530FF8EE, 0x468DDE7D,
	...
	0xD0DADECB, 0xD50ADA38, 0x0339C32A, 0xC6913667,
	0x8DF9317C, 0xE0B12B4F, 0xF79E59B7, 0x43F5BB3A,
	0xF2D519FF, 0x27D9459C, 0xBF97222C, 0x15E6FC2A,
	0x0F91FC71, 0x9B941525, 0xFAE59361, 0xCEB69CEB,
	...
	0xD3A0342B, 0x8971F21E, 0x1B0A7441, 0x4BA3348C,
	0xC5BE7120, 0xC37632D8, 0xDF359F8D, 0x9B992F2E,
	0xE60B6F47, 0x0FE3F11D, 0xE54CDA54, 0x1EDAD891,
	0xCE6279CF, 0xCD3E7E6F, 0x1618B166, 0xFD2C1D05,
	...
	0x4C50901B, 0x71C65614, 0xE6C6C7BD, 0x327A140A,
	0x45E1D006, 0xC3F27B9A, 0xC9AA53FD, 0x62A80F00,
...
)
{
	...
	/* copy S-Boxes */
	memcpy(s->s0, pi + i, 1024);
	memcpy(s->s1, pi + i + 256, 1024);
	memcpy(s->s2, pi + i + 512, 1024);
	memcpy(s->s3, pi + i + 768, 1024);
